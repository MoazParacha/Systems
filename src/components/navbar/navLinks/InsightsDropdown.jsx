      ...
      <div className="hidden md:block fixed left-0 top-16 w-full bg-white text-black shadow-lg 
        ...
        <div className="flex">
          ...
          <div className="pl-20 pt-10">
            <Link to="Casestudies" className="text-2xl font-semibold hover:text-orange-700">Cases studies</Link>
            <Link to="Whitepapers/eBooks"  className="text-2xl font-semibold hover:text-orange-700 mt-5 block">Whitepapers/eBooks</Link>
            <Link to="/Blogs" className="text-2xl font-semibold hover:text-orange-700 mt-5 block">Blogs</Link>
            <Link to="/Newsroom" className="text-2xl font-semibold hover:text-orange-700 mt-5 block">Newsroom</Link>
          </div>
        </div>
      </div>
    </div>
