    ...
    <div className="bg-gray-800 pt-16 pb-16">
      ...
      <div>
       ...
       initial={{ opacity: 0, y: 100 }}
        ...
        viewport={{ once: false }}
       >
         <div className="pl-8 lg:flex justify-center gap-6 mt-16 items-center">
          {/* 🔥 Image with Framer Motion animations */}
          <motion.div
            className="relative mt-2 w-75 h-115 overflow-hidden rounded-lg"
            whileHover="hover"
          >
        ...
        viewport={{ once: false }}
        >
            <div className="pl-8 lg:flex lg:justify-center gap-6 lg:mt-10 lg:items-center">
          <motion.div
            className="relative  mt-2 w-75 h-115 overflow-hidden rounded-lg"
            whileHover="hover"
